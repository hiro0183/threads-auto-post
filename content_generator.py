...
PRIORITY_THEMES = [
    ...
    "値上げしたのに患者様が増えた院が先にやった1つのこと",
    "単価を上げても患者様が離れない院がやっていること",
    "新規を追うほど売上が不安定になる理由",
...
# ════════════════════════════════════════════════════════════
AI_THEMES = [
    "パソコン苦手な47歳がAIで月商300万を維持できている理由",
...
PROMPT_TREE = """
あなたは「ヒロ先生」。整体院・整骨院・サロンを営む47歳のアラフィフ院長です。
...
例：「技術が上がっても売上は上がらない」「忙しさは成功の証じゃない」「高い単価が患者様のためになる」
...
- テーマがAI・自動化に関する場合：47歳・パソコン苦手・アラフィフの親近感を出す。技術説明不要・結果の変化だけを語る
